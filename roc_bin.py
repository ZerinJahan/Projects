...
from sklearn.multiclass import OneVsRestClassifier
classifier = OneVsRestClassifier(AdaBoostClassifier(n_estimators = 50))
y_pred = classifier.fit(x_train,y_train).predict(x_test)'''

'''#classifier naive bayes gaussian (use .toarray() after onehot encoding)
from sklearn.naive_bayes import CategoricalNB
from sklearn.multiclass import OneVsRestClassifier
classifier = OneVsRestClassifier(CategoricalNB())
y_pred = classifier.fit(x_train,y_train)'''
...
#classifier naive bayes categorical 
from sklearn.naive_bayes import CategoricalNB
classifier = CategoricalNB()
y_pred= classifier.fit(x_train,y_train).predict(x_test)
...
plt.savefig('F:/pics/cat.png', dpi=400)
plt.show()
