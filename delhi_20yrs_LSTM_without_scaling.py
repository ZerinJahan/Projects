...
#
n_timestamp = 24*1
train_days = 24*30  # number of days to train from(hours*no of days)
testing_days = 24*5 # number of days to be predicted(hours*no of days)
n_epochs = 25
filter_on = 1
...
url="F:/thesis topic with JP ZERIN/district/WeatherLSTM-master/data/df_test_delhi.csv"
...
#--- breaking the scaling by breaking the inverse_transform ---
y_predicted_descaled = y_predicted
y_train_descaled = y_train
...
mdl_avl = model.evaluate(X_test, y_test, verbose=0)
...
print("\bMSE=" + str(round(mse,2)))
print("R2=" + str(round(r2,2)))

print("RMSE: ", math.sqrt(mean_squared_error(y_test_descaled, y_predicted_descaled)))
print("MAE: ", mean_absolute_error(y_test_descaled, y_predicted_descaled))

# -- MAPE --
mape = tf.keras.losses.MeanAbsolutePercentageError()
print("MAPE: " + str(mape(y_test_descaled, y_predicted_descaled).numpy()))
